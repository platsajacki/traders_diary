...
class LinearUSDTGetterService(DataPipelineService):
    ...
    def process_data(self, data: dict) -> list[str]:
        ...
        for symbol_data in data:
            ...
            if symbol_data['quoteCoin'] != USDT or symbol_data['isPreListing']:
                continue
            if '1000' in symbol or '-' in symbol:
                continue
    ...
    def fetch_data(self) -> dict:
        ...
        """
        return http_bybit.get_instruments_info(category=LINEAR, limit=1000)
    ...
    def save_to_database(self, coins: Any) -> None:
        ...
        """
        usdt, _ = FinancialAsset.objects.get_or_create(ticker=USDT, **FUTURES_BYBIT_DATA)  # type: ignore[arg-type]
        pairs = []
